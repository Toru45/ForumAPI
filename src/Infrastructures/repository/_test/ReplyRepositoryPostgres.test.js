...
describe('ReplyRepositoryPostgres', () => {
  ...
  describe('getRepliesByCommentId function', () => {
    it('should return comment replies correctly', async () => {
      ...
      expect(replies[0].id).toBe('reply-old'); 
      ...
      expect(replies[0].comment).toBe(commentId);
      expect(replies[1].comment).toBe(commentId);
      expect(replies[0].owner).toBe(otherUserId);
